...
function isUrgenteAd(ad: any): boolean {
  // [URGENTE] Novo: só flag explícito isUrgent de verificados azul/dourado
  // [SEC-FIX] CWE-20: não usa mais heurística tipo preciso para evitar spam
  return !!ad.isUrgent;
}
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9FB]">
      {/* Header - com sino + chat ajuda + avatar (HeaderActions) */}
